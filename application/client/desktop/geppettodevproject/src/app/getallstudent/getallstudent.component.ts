...
export class GetallstudentComponent implements OnInit {
    columnDefs: any = [{ headerName: 'Name', field: 'Name'  },{ headerName: 'Email', field: 'Email'  },{ headerName: 'Department', field: 'Department'  },{ headerName: 'Collage', field: 'College'  },{ headerName: 'Place', field: 'Place'  },];
    public student = {
        Name: '',
        Email: '',
        Department: '',
